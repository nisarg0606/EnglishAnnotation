      ...
      // if (data.data.tweets[i].assignedTo.slice(0,2).includes(name)){
            ...
            for (comm_key in data.data.tweets[i].comments) {
              console.log(data.data.tweets[i]);
                if ((data.data.tweets[i].comments[comm_key].tweet_id in data.data.tweets[i].annotations)===true && ((data.data.tweets[i].comments[comm_key].tweet_id in data.data.tweets[i].finalAnnotation)===false)){
